  ...
  event.respondWith((async () => {
    try {
      ...
      if (request.mode === "navigate" || (request.headers.get("Accept") || "").includes("text/html")) {
        return new Response(
          `<!doctype html><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>KuraHome</title><p>Offline. <a href="/">KuraHome</a></p>`,
